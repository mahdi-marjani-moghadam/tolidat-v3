                          ...
                          <?php echo $value['title'] ?>
                            ...
                            <div class="pull-right innerContent">
                                <div class="logoContainer-img logoContainer pull-right">
                                    <img class="width transition roundCorner boxBorder lazy" data-src="<?php echo(strlen($value['image']) > 0 ? COMPANY_ADDRESS . $value['company_id'] . '/honour/' . $value['image'] : DEFULT_LOGO_ADDRESS); ?>" alt="<?= ' افتخار ' . $value['title'] ?>" title="<?= $value['title'] ?>">
                                </div>
