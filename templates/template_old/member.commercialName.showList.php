...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="holder-title center-block">
            <span data-intro="در صورت داشتن نام تجاری ثبت شده،آن را به همراه لوگو وارد نمایید." class="title-pro">نام تجاری</span>
            <button data-position="right" data-intro="اضافه کردن تجاری" type="button" class="btn btn-sm pull-left add-btnPro" data-toggle="modal" data-target="#myModal2" data-backdrop="static">
                <i class="fa fa-plus transition bc-color-violet" aria-hidden="true"></i>
                <span class="transition">افزودن نام تجاری</span>
            </button>
        </div>
    </div>
</div>
...
<!--Modal add-->
<div class="holder-modal modal-commercialName modal fade container-floatinglabel" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title roundCorner" id="myModalLabel">افزودن نام تجاری</h5>
                <p id="message"></p>
            </div>
            <div class="modal-body">
                ...
                <form id="addCommercialName" class="form" enctype="multipart/form-data" method="post" data-toggle="validator">
                    <div class="row">
...
<!--Modal Edit-->
<div class="holder-modal modal-commercialName modal fade container-floatinglabel" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h5 class="modal-title roundCorner" id="myModalLabel">ویرایش نام های تجاری</h5>
                <p id="message"></p>
            </div>
            <div class="modal-body">
                <div class="iziAdd-container"></div>
                ...
                <form id="editCommercialName" class="form" enctype="multipart/form-data" method="post" data-toggle="validator">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6 pull-right">
                            <div class="form-group mb">
                        ...
                        <input name="Commercial_name_d_id" type="hidden">
                    </div>
                    <div class="modal-footer noPadding pt">
            ...
            $.httpRequest('/member/companyCommercialName/edit/', 'post', formData)
                .then(function (data) {
                    ...
                    if (response.fields.result == -1) {
                        ...
                        var commercial_name_d_id = response.fields.Commercial_name_d_id,
                            commercial_name_d_id_old = response.fields.Commercial_name_d_id_old,
                            commercial_name_d_id_oldest = response.fields.Commercial_name_d_id_oldest,
                            date = response.fields.date,
                            title = response.fields.title,
                            image = response.fields.img,
                            image_name = response.fields.image,
                        ...
                        $(".remove-commercialName").each(function () {
                            if ($(this).data('value') == commercial_name_d_id_old || $(this).data('value') == commercial_name_d_id_oldest) {
                                ...
                                $(this).find('.link-edit').data('value', commercial_name_d_id);
