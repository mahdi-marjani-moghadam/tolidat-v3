    ...
    <div class="boxContainer reg-container">
        ...
        <div class="registerPage container-floatinglabel center-block whiteBg boxBorder roundCorner boxContainer">
            <header>
                ...
                <a class="container-badge" href="#"><div class="badge">2 از 6</div></a>
            </header>
            <div class="content">
                    ...
                    <div class="row">
                        <div class="col-xs-12  col-sm-12 col-md-12">
                            <div class="form-group has-feedback center-block">
                                ...
                                <input name="token" type="text" value="<?php echo $list['data']['token'] ?>" class="form-control fullWidth displayBlock noRadius noPadding transition" id="registration_number" data-minlength="3" data-error="لطفا کد فعالسازی را وارد نمایید" tabindex="1" autofocus required>
                            </div>
                        </div>
                    </div>
                    <!-- separator -->
                    ...
                    <div class="row">
                        <div class="col-xs-12  col-sm-12 col-md-12 mb ">
                            ...
                            <button type="button" id="sendCodeAgain" class="btn btn-primary dropdown-toggle reg-btn-refresh center-block text-white" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="fa fa-refresh"></span><img style="display: none" id="loading" src="<?=RELA_DIR?>templates/template_fa/assets/images/loading1.gif" > ارسال مجدد
                            </button>
                        </div>
                    </div>
                    <div class="row xsmallSpace"></div>
