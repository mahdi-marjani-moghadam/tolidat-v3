<?php //dd($list['packageUsage']); ?>
<div class="content-control">
    <!--control-nav-->
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24"><i class="sidebar-icon fa fa-archive"></i>ویرایش تولیدی حقیقی </a></li>
    </ul><!--/control-nav-->
</div><!-- /content-control -->
...
<div class="content-body">
    <div id="panel-tablesorter" class="panel panel-warning">
        <div class="panel-heading bg-white">
            <h3 class="panel-title rtl">فرم ویرایش تولیدی حقیقی </h3>
                    ...
                    <form name="queue" id="queue" role="form" data-validate="form" class="form-horizontal"
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="text" class="form-control" name="company_name"
                                                id="company_name"
                                                value="<?php echo   $list['companyInfo']['company_name'] ?>">
                                    </div>
                                </div>
                            </div>
                            <div id="personality_box" class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 pull-right control-label rtl"
                                            for="description">زمینه فعالیت:</label>
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <textarea rows="4" cols="50" class="form-control" name="description"
                                                id="description" required><?php echo   $list['companyInfo']['description'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="text" class="form-control" name="maneger_name"
                                                id="maneger_name" value="<?php echo   $list['companyInfo']['maneger_name'] ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <textarea rows="4" cols="50" class="form-control" name="address"
                                                id="address" required><?php echo   $list['addressInfo']['address'] ?></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 pull-right control-label rtl"
                                            for="reference_value">توضیحات مرجع تایید:</label>
                                    <div class="col-xs-12 col-sm-8 pull-right">
                        ...
                        <div class="row">
                            <label class="col-xs-12 col-sm-4 col-md-4 pull-right control-label rtl"
                                    for="editor_phone">تصویر لوگو:</label>
                            <div class="col-xs-12 col-sm-12 col-md-6">

                                <div class="docs-buttons">
                                    <div class="img-container upload-msg">
                                        <img class="image-crop"
                                                src="<?php echo(isset($list['logoInfo']['image']) ? COMPANY_ADDRESS . $list['logoInfo']['company_id'] . "/logo/" . $list['logoInfo']['image'] : '/templates/' . CURRENT_SKIN . '/assets/images/placeholder.png'); ?>"
                                                alt="Picture">
                                    </div>
                                    <div class="btn-block mt">
                                        <label class="btn-block btn btn-success uploud-btnProCrop pull-right"
                                            ...
                                            <input class="result-crop" type="hidden" name="logoImage"
                                                    value="">
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 pull-right">
                                        <select name="licence_type" id="licence_type">
                                            ...
                                            foreach ($list['licence'] as $key => $value) {
                                                ?>
                                                <option value="<?php echo   $value['Licence_list_id'] ?>" <?php echo   ($list['licenceInfo']['licence_type'] == $value['Licence_list_id']) ? 'selected' : '' ?>>
                                                    <?php echo   $value['name'] ?>
                                                </option>
                                                <?php 
                                            }
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6" id="licence_box">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6">
                        ...
                        <div class="row" id="companyLogo-container">
                            ...
                            <label class="col-xs-12 col-sm-4 col-md-4 pull-right control-label rtl"
                                    for="editor_phone">تصویر جواز:</label>
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="docs-buttons">
                                    <div class="img-container">
                                        <img class="width image-banner"
                                                src="<?php echo(isset($list['licenceInfo']['image']) ? COMPANY_ADDRESS . $list['licenceInfo']['company_id'] . "/licence/" . $list['licenceInfo']['image'] : '/templates/' . CURRENT_SKIN . '/assets/images/placeholder.png'); ?>" alt="Picture">
                                    </div>
                                    <div class="btn-block mt">
                                        <label class="btn-block btn btn-success uploud-btnProCrop pull-right"
                                            ...
                                            <input type="file" class="sr-only" id="inputImage-banner"
                                                    name="file" accept=".jpg,.jpeg,.png,.gif,.bmp,.tiff">
                                            <input class="result-cropBanner" type="hidden" name="licenceImage"
                                                    value="">
                                            <span class="docs-tooltip pull-right" data-animation="false"
                                                    title="Import image with Blob URLs">
                                                                    <span>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#showLog">
                                    نمایش لاگها
                                </button>
                            </div>
                            <br>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <textarea id="log" name="text" rows="4" cols="50"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <p class="pull-right">
                                    <button type="submit" name="update" id="submit"
                                        ...
                                        <input type="hidden" name="company_type"
                                                value="2"> <input type="hidden" name="company_id"
