        ...
        <div class="panel-body">
            <div class="table-responsive table-responsive-datatables">
                <div class="pull-right">
                    <a href="<?php echo RELA_DIR ?>admin/?component=honour&company_id=<?php echo $list['company_id']; ?>&action=add"
                       class="btn btn-primary btn-sm btn-icon text-13"><i class="fa fa-plus"></i>افزودن افتخار جدید</a>
                </div>
                ...
                <table id="example" class="companyTable table table-striped table-bordered rtl" cellspacing="0"
                    ...
                    if (isset($list['list'])) {
                        foreach ($list['list'] as $id => $fields) {
                            ?>
                            <tr>
                                <td><?php echo $fields['Honour_id']; ?></td>
                                <td><?php echo $fields['title']; ?></td>
                                <td><?php echo $fields['description']; ?></td>
                                <td dir="ltr" align="center"><img height="60px"
                                                                  src="<?= COMPANY_ADDRESS . $fields['company_id'] . "/honour/" . $fields['image'] ?>"/>
                                </td>
                                <td>
                                    <a href="<?= RELA_DIR ?>admin/?component=honour&action=edit&id=<?php echo $fields['Honour_id']; ?>">ویرایش</a>
                                    <br/>

                                    <a href="<?= RELA_DIR ?>admin/?component=honour&action=deleteHonour&id=<?php echo $fields['Honour_id']; ?>">حذف</a>
                                </td>
