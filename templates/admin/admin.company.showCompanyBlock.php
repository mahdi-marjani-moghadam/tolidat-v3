...
<div class="content-control">
    ...
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24"><i class="sidebar-icon fa fa-adn"></i>  لیست تمامی کمپانی قفل</a></li>
    </ul>
    <!--/control-nav-->
</div>
<!-- /content-control -->
...
<div class="content-body">
    ...
    <div id="panel-1" class="panel panel-default border-blue">
        <div class="panel-heading bg-blue">
            <h3 class="panel-title rtl ">لیست تمامی کمپانی قفل</h3>
        ...
        <div class="panel-body">
            ...
            <div class="table-responsive table-responsive-datatables">
                <table id="example" class="companyTable table table-striped table-bordered rtl" cellspacing="0"
                    ...
                    <tfoot>
                    <tr>
                        <th><input type="text" name="search_1" id="search_1" class="search_init form-control"/></th>
                        <th><input type="text" name="search_2" id="search_2" class="search_init form-control"/></th>
                        ...
                        <th><input type="text" name="search_4" id="search_4" class="search_init form-control"/></th>
                        ...
                        <th><input type="text" name="search_6" id="search_6" class="search_init form-control"/></th>
                        ...
                        <th><input type="text" name="search_8" id="search_8" class="search_init form-control"/></th>
                        <th><input type="text" name="search_9" id="search_9" class="search_init form-control date"></th>
