...
<div class="content-control">
    ...
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24">لگو<i class="sidebar-icon fa fa-info"></i></a></li>
    </ul><!--/control-nav-->
</div><!-- /content-control -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="text" class="form-control" name="title" id="title"
                                                placeholder=" title " required value="<?= $list['title'] ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p class="pull-right">
                                    ...
                                    <input name="Banner_id" type="hidden" id="company_id"
                                            value="<?= $list['Banner_id'] ?>"/>
