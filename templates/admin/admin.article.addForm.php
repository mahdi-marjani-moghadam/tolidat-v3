                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="text" class="form-control" name="brif_description" id="brif_description" autocomplete="off" required >
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-10 pull-right">
                                        ...
                                        <!-- <textarea type="text" class="form-control" name="description" id="description" rows="6" autocomplete="off" required ></textarea> -->
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <textarea type="text" class="form-control" name="meta_description" id="meta_description" autocomplete="off" required ></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
