                    ...
                    <form name="queue" id="queue" role="form" data-validate="form" class="form-horizontal"
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="text" class="form-control" name="title" id="title"
                                                placeholder="عنوان" required value="<?= $list['list']['title'] ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6">
                          ...
                          <textarea name="description" class="form-control"
                                  ...
                                  required="required"><?= $list['list']['description'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-8">
                                    <div class="docs-buttons">
                                        <div class="img-container upload-msg">
                                            <img class="image-banner width" src="<?= (trim($list['product']['image'])!='')? COMPANY_ADDRESS.$list['product']['company_id']."/product/".$list['product']['image']:  RELA_DIR . "templates/admin/assets/img/placeholder.png" ?>" alt="Picture">
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p class="pull-right">
                                    ...
                                    <input name="Business_licence_id" type="hidden" id="Business_licence_id"
                                            value="<?= $list['list']['Business_licence_id'] ?>"/>
                                    <input name="company_id" type="hidden" id="company_id"
                                            value="<?= $list['list']['company_id'] ?>"/>
