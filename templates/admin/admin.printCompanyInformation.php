...
<div class="main-content">
    ...
    <p style="margin: 0px">موضوع: به روز رسانی اطلاعات شرکت
    ...
    <p style="margin-top: 5px; margin-bottom: 10px">
        ...
        <br> کارشناسان تیم تولیدات به صورت مستمر در حال به روز رسانی اطلاعات موجود در این مرجع می باشند. در همین راستا پیرو مذاکره تلفنی با سرکار خانم / جناب آقای
        <span class="dotted" style="width: 110px;"><?php echo (!empty($list['list']['memberInfo']['name'] . $list['list']['memberInfo']['family'])) ? $list['list']['memberInfo']['name'] . " " . $list['list']['memberInfo']['family'] : $list['list']['company']['maneger_name'] ?></span> مورخ
        <span class="dotted" style="width: 90px;"><?php echo convertDate($list['list']['company']['refresh_date']); ?></span> اطلاعات مجموعه شما دریافت و اعتبارسنجی گردید و پروفایل اختصاصی شرکت
        <span class="dotted" style="160px"><?php echo $list['list']['company']['company_name']; ?></span> به روز رسانی شد. اطلاعات دریافتی به شرح زیر می باشد که از طریق لینک <?php echo '<span class=" ltr">  www.tolidat.ir/c/<span style="font-family:Arial;font-size: 12px">' . $list['list']['company']['Company_id'] . '</span></span>'; ?>
        قابل مشاهده است.
    </p>
    ...
    <table class="rtl">
        ...
        <tr>
            ...
            <td class="row-title">تیزر تبلیغاتی</td>
            <td class="text-center">
