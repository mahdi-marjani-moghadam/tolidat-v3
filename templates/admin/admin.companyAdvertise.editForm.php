...
<div class="content-body">
    ...
    <div id="panel-tablesorter" class="panel panel-warning">
        <div class="panel-heading bg-white">
            <h3 class="panel-title rtl">نام تجاری کمپانی</h3>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-8  center-block">
                    <form name="queue" id="queue" role="form" data-validate="form" class="form-horizontal"  novalidate="novalidate" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row" id="companyCommercialName-container">
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="title">عنوان:</label>
                                        <div class="col-xs-12 col-sm-8 pull-right">
                                            <input type="text" class="form-control" name="title" id="title"  placeholder=" عنوان " required value="<?=$list['title']?>"></div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8 pull-right">
                                            <textarea name="description" class="form-control" id="description" placeholder="توضیحات" required="required"><?=$list['description']?></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8 pull-right">
                                            <input type="text" class="form-control date" name="startDate" id="startDate"  placeholder="تاریخ شروع" required value="<?= $list['startDate'] != '0000-00-00' ? convertDate($list['startDate']) : ''?>"></div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="expireDate">تاریخ انقضاء:</label>
                                        <div class="col-xs-12 col-sm-8 pull-right">
                                            <input type="text" class="form-control date" name="expireDate" id="expireDate"  placeholder="تاریخ انقضاء" required value="<?=$list['expireDate'] != '0000-00-00' ? convertDate($list['expireDate']) : ''?>"></div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-8">
                                                <div class="docs-buttons">
                                                    <div class="img-container upload-msg">
                                                        <img class="image-crop" src="<?= count($list['image']) > 0 ? COMPANY_ADDRESS . $list['company_id'] . "/advertise/" . $list['image'] : RELA_DIR . "templates/admin/assets/img/placeholder.png" ?>" alt="Picture">
                                                    </div>
                                                    <div class="btn-block mt">
                                                        <label class="btn-block btn btn-success uploud-btnProCrop pull-right" for="inputImage" title="Upload image file">
                                                            ...
                                                            <input class="result-crop" type="hidden" name="AdvertiseImage" value="">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p class="pull-right">
                            ...
                            <input name="Advertise_id" type="hidden" id="company_id" value="<?=$list['Advertise_id']?>" />
