                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8 pull-right">
                                            <input type="text" class="form-control" name="subject"
                                                    id=" " value="<?php echo($list['subject']) ?>">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-9 pull-right">
                                            <input type="email" class="form-control" id="email_email"
                                                    name="email" value="<?php echo($list['email']) ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <p class="pull-right margin-right">
                                    <button type="submit" name="update" id="submit"
                                        ...
                                        <input name="Emails_id" type="hidden" id="Emails_id"
                                                value="<?= $list['Emails_id'] ?>"/> <i class="fa fa-plus"></i>ویرایش
                                    </button>
