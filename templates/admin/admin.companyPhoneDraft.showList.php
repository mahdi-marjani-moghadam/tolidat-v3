...
<div class="content-control">
    ...
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24"><i class="sidebar-icon fa fa-adn"></i>لیست تلفن های ویرایش شده</a></li>
    </ul><!--/control-nav-->
</div><!-- /content-control -->
...
<div class="content-body">
    ...
    <div id="panel-1" class="panel panel-default border-blue">
        <div class="panel-heading bg-blue">
            <h3 class="panel-title rtl">لیست تلفن های ویرایش شده</h3>
                        ...
                        foreach ($list as $id => $fields) {
                            ...
                            <tr>
                                ...
                                <td dir="ltr" align="center">
                                    <a href="<?php echo  RELA_DIR ?>admin/?component=companyPhones&action=editDraftCompanyPhone&id=<?php echo $fields['Phones_d_id']; ?>&branch_id=<?php echo $fields['branch_id']; ?>">بررسی</a>
                            </tr>
