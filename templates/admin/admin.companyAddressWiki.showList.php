...
<div class="content-control">
  ...
  <ul class="control-nav pull-right">
    <li><a class="rtl text-24"><i class="sidebar-icon fa fa-adn"></i>لیست آدرس های ویکی</a></li>
  </ul><!--/control-nav-->
</div><!-- /content-control -->
...
<div class="content-body">
  ...
  <div id="panel-1" class="panel panel-default border-blue">
    <div class="panel-heading bg-blue">
      <h3 class="panel-title rtl">لیست آدرس های ویکی</h3>
          ...
          if(isset($list['list'])) {
            foreach ($list['list'] as $id =>$fields) {
              ...
              <tr>
                ...
                <td>
                <a href="<?=RELA_DIR?>admin/?component=companyAddresses&action=editWikiCompanyAddress&id=<?php echo $fields['Addresses_d_id']; ?>">بررسی</a> <br/>
