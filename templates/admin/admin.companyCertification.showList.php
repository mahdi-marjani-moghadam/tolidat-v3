    ...
    <div id="panel-1" class="panel panel-default border-blue">
        ...
        <div class="panel-body">
            <div class="pull-right">
                <a href="<?= RELA_DIR ?>admin/?component=certification&company_id=<?php echo $list['company_id']; ?>&action=addCompanyCertification"
                   class="btn btn-primary btn-sm btn-icon text-13"><i class="fa fa-plus"></i> افزودن گواهی جدید</a>
            </div>
            <!-- separator -->
                    ...
                    if (isset($list['list'])) {
                        foreach ($list['list'] as $id => $fields) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= RELA_DIR ?>admin/?component=certification&action=editCompanyCertification&id=<?php echo $fields['Certification_id']; ?>">ویرایش</a>
                                    <br/>
                                    <a href="<?= RELA_DIR ?>admin/?component=certification&action=deleteCompanyCertification&id=<?php echo $fields['Certification_id']; ?>">حذف</a>
                                </td>
                            </tr>
                            <?php
                        }
