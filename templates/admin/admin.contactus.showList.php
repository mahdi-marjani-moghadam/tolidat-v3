          ...
          if(isset($list['list'])) {
            foreach ($list['list'] as $id =>$fields) {
              ...
              <tr>
                ...
                <td><a href="<?php echo RELA_DIR?>admin/?component=contactus&action=showMore&id=<?php echo $fields['Contact_id']; ?>">نمایش</a>
                  <a href="<?php echo RELA_DIR?>admin/?component=contactus&action=deleteContactUs&id=<?php echo $fields['Contact_id']; ?>">حذف</a> </td>
