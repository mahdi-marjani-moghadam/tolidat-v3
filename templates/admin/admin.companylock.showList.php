<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function () {
        ...
        var oTable = dataTable.DataTable({
            ...
            "aaSorting": [],
            "ajax": "<?=RELA_DIR?>admin/?component=company&action=searchLockById&member_id=<?=$list['member_id']?>",
...
<div class="content-control">
    ...
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24"><i class="sidebar-icon fa fa-adn"></i>لیست کمپانی ها lock شده کاربر</a></li>
    </ul>
    <!--/control-nav-->
</div>
<!-- /content-control -->
...
<div class="content-body">
    ...
    <div id="panel-1" class="panel panel-default border-blue">
        <div class="panel-heading bg-blue">
            <h3 class="panel-title rtl ">لیست کمپانی ها lock شده کاربر</h3>
