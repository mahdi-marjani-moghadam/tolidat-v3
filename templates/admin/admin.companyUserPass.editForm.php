<div class="content-control">
    ...
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24"><i class="sidebar-icon fa fa-newspaper-o"></i> ویرایش نام کاربری و کلمه عبور </a>
        </li>
    </ul><!--/control-nav-->
</div><!-- /content-control -->
<div class="content-body">
    <div id="panel-tablesorter" class="panel panel-warning">
        <div class="panel-heading bg-white">
            <h3 class="panel-title rtl">فرم نام کاربری و کلمه عبور</h3>
                ...
                <div class="col-xs-12 col-sm-12 col-md-8  center-block">
                    <form name="queue" id="queue" role="form" data-validate="form" class="form-horizontal"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="text" class="form-control" name="username" id="username"
                                                autocomplete="off" placeholder="نام کاربری  " required
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="password">کلمه عبور :</label>
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="text" class="form-control" name="password" id="password"
                                                autocomplete="off" placeholder="کلمه عبور "
                                                value="">
                                    </div>
                                </div>
                            </div>
                                ...
                                <p class="pull-right">
                                    <button type="submit" name="update" id="submit"
                                        ...
                                        <input name="company_id" type="hidden" id="company_id"
                                                value="<?php echo $list['company_id'] ?>"/> <i class="fa fa-plus"></i> ویرایش
                                    </button>
...
<script>
    $("#username").on("blur", function () {
        $.ajax({
            url: "<?php echo RELA_DIR . 'admin/?component=company&action=checkUsernameAjax'?>",
