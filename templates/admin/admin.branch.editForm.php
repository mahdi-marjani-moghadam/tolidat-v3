<div class="content-control">
    ...
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24"><i class="sidebar-icon fa fa-archive"></i> ویرایش بلک لیست</a></li>
    </ul><!--/control-nav-->
</div><!-- /content-control -->
<div class="content-body">
    <div id="panel-tablesorter" class="panel panel-warning">
        <div class="panel-heading bg-white">
            <h3 class="panel-title rtl">ویرایش ادمین</h3>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="phone">نام نمایندگی :</label>
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="text" class="form-control" name="branch_name" id="branch_name" autocomplete="off" required value="<?= $list['branch']['branch_name'] ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="phone">نام مدیر :</label>
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="text" class="form-control" name="maneger_name" id="maneger_name" autocomplete="off" required value="<?= $list['branch']['maneger_name'] ?>">
                                    </div>
                                </div>
                            </div>
                            <!-- state -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 pull-right">
                                        <select name="state_id" id="province_id" data-input="select2">
                                            ...
                                            <option
                                                <?= $value['province_id'] == $list['branch']['state_id'] ? 'selected' : '' ?>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 pull-right">
                                        <select name="city_id" id="city_id" data-input="select2"> </select>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <p class="pull-right">
                                    <button type="submit" name="update" id="submit" class="btn btn-icon btn-success rtl">
                                        ...
                                        <input name="branch_id" type="hidden" id="branch_id" value="<?php echo $list['branch']['Branch_id']; ?>"/>
                                        <input name="company_id" type="hidden" id="company_id" value="<?php echo $list['branch']['company_id']; ?>"/>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var city = <?php echo($list['branch']['city_id']);?>
