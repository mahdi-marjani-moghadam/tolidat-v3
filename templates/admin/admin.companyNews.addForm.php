<div class="content-control">
    ...
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24"><i class="sidebar-icon fa fa-adn"></i> افزودن خبر جدید</a></li>
    </ul><!--/control-nav-->
</div><!-- /content-control -->
                    ...
                    <form name="queue" id="queue" role="form" data-validate="form" class="form-horizontal" novalidate="novalidate" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 pull-right control-label rtl"
                                            for="date">تاریخ خبر</label>
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="text" class="form-control date" name="date_news" id="date" value="<?= $list['date_news'] ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                            ...
                                            <div class="docs-buttons">
                                                ...
                                                <div class="btn-block mt">
                                                    <label class="btn-block btn btn-success uploud-btnProCrop pull-right" for="inputImage" title="Upload image file">
                                                        ...
                                                        <input class="result-crop" type="hidden" name="newsImage" value="">
