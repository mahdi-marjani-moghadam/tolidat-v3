        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-8  center-block">
                    <form name="queue" id="queue" role="form" data-validate="form" class="form-horizontal" novalidate="novalidate" method="post">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="text" class="form-control" name="brief_description" id="brief_description" required value="<?= $list['brief_description'] ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!--                                                        <img class="width image-banner" src="--><?php //echo RELA_DIR . "templates/admin/assets/img/placeholder.png" ?><!--" alt="Picture">-->
                                                        <img class="image-banner width" src="<?= strlen(trim($list['image'])) > 0 ? IMAGES_RELA_DIR."banner/".$list['image'] :  RELA_DIR . "templates/admin/assets/img/placeholder.png" ?>" alt="Picture">
                                                    </div>
                                                    <div class="btn-block mt">
                                                        <label class="btn-block btn btn-success uploud-btnProCrop pull-right" for="inputImage-banner" title="Upload image file">
                                                            ...
                                                            <input class="result-cropBanner" type="hidden" name="imageCropped" value="">
