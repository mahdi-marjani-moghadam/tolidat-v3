                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 pull-right control-label rtl"
                                            for="certification_list_id">گواهی:</label>
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <select name="certification_list_id" id="certification_list_id" required>
                                            <option value="" selected></option>
                                            <?php
                                            foreach ($list['list'] as $key => $value) {
                                                ?>
                                                <option value=" <?php echo $value['Certification_list_id']; ?> ">
                            ...
                            <div class="col-md-12">
                                <p class="pull-right">
                                    <button type="submit" name="update" id="submit"
                                        ...
                                        <input name="company_id" type="hidden" id="action" value="<?php echo $list['company_id']; ?>">
