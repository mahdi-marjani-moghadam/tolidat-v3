                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <img height="293" src="<?= IMAGES_RELA_DIR . 'banner/exhibition/' . $list['image'] ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-12 pull-right">
                                        <textarea class="form-control" name="description" id="description" cols="100" rows="5"><?= $list['description'] ?></textarea>
                                        <input type="hidden" name="banner_exhibition_id" value="<?= $list['banner_exhibition_id'] ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
