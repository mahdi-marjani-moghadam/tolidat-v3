<div class="content-control">
    ...
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24">ویرایش نحوه ارسال<i class="sidebar-icon fa fa-info"></i></a></li>
    </ul><!--/control-nav-->
</div><!-- /content-control -->
<div class="content-body">
    <div id="panel-tablesorter" class="panel panel-warning">
        <div class="panel-heading bg-white">
            <h3 class="panel-title rtl">فرم ویرایش نحوه ارسال </h3>
        ...
        <div class="panel-body">
            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8 pull-right">
                                            <input type="text" class="form-control" name="action" id="action"
                                                   placeholder=" نحوه ارسال " required value="<?= $list['action'] ?>"></div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8 pull-right">
                                            <textarea name="message" class="form-control" id="message" placeholder="پیام" required="required" rows="10" cols="20"><?= $list['message'] ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-10">
                        <p class="pull-left">
                            <input type="hidden" name="letter_action_id" value="<?= $list['letter_action_id'] ?>">
