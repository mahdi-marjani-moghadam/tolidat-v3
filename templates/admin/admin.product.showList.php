    ...
    <div class="panel-body">
      <div class="table-responsive table-responsive-datatables">
        <div class="pull-right">
          <a href="<?php echo RELA_DIR ?>admin/?component=product&company_id=<?php echo $list['company_id']; ?>&action=add" class="btn btn-primary btn-sm btn-icon text-13"><i class="fa fa-plus"></i> افزودن محصول جدید</a>
        </div>
        ...
        <table id="example" class="companyTable table table-striped table-bordered rtl" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            ?>
                <tr>
                  <td><?php echo $fields['Product_id']; ?></td>
                  <td><?php echo $fields['title']; ?></td>
                  <td><?php echo $fields['brif_description']; ?></td>
                  <td><?php echo $fields['description']; ?></td>
                  <td dir="ltr" align="center"> <img height="60px" src="<?php echo COMPANY_ADDRESS . $fields['company_id'] . "/product/" . $fields['image']; ?>" /> </td>
                  <td>
                    <a href="<?php echo RELA_DIR ?>admin/?component=product&action=edit&id=<?php echo $fields['Product_id']; ?>">ویرایش</a> <br />
                    <a href="<?php echo RELA_DIR ?>admin/?component=product&action=delete&id=<?php echo $fields['Product_id']; ?>">حذف</a>
                  </td>
