...
<div class="content-body">
    <div id="panel-tablesorter" class="panel panel-warning">
        <div class="panel-heading bg-white">
            <h3 class="panel-title rtl">فرم لگو</h3>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-8  center-block">
                    <form name="queue" id="queue" role="form" data-validate="form" class="form-horizontal" novalidate="novalidate" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-3">
                            <img src="<?= COMPANY_LOGO_IMAGE . $list['company_id'] . "/logo/" . $list['image'] ?>"
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input name="companyLogo" class="" type="file" value="انتخاب فایل"/>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p class="pull-right">
                                    ...
                                    <input name="logo_id" type="hidden" id="company_id" value="<?= $list['logo_id'] ?>"/>
