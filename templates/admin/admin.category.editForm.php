        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-8  center-block">
                    <form name="queue" id="queue" enctype="multipart/form-data" role="form" data-validate="form" class="form-horizontal" autocomplete="off" novalidate="novalidate" method="post">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <select class="valid" name="parent_id" id="parent_id">
                                            ...
                                            <?php foreach ($list['category_list'] as $category_id => $value) { ?>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="text" class="form-control" name="alt" id="alt" autocomplete="off" required value="<?php echo  $list['alt'] ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="text" class="form-control set-font-latin ltr" name="url" id="url" autocomplete="off"  value="<?php echo  $list['url'] ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="text" class="form-control set-font-latin" name="sort" id="sort" autocomplete="off"  value="<?php echo  $list['sort'] ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row xsmallSpace hidden-xs"></div>
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8 pull-right">
                                            <textarea name="meta_description" class="form-control fullFix" id="meta_description" autocomplete="off"><?php echo  $list['meta_description']; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
