...
<div class="content-body">
    <div id="panel-tablesorter" class="panel panel-warning">
        <div class="panel-heading bg-white">
            <h3 class="panel-title rtl">فرم مرحله دوم ثبت نام حقوقی</h3>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-8  center-block">
                    <form name="queue" id="queue" role="form" data-validate="form" class="form-horizontal"
                            ...
                            action="<?php echo  RELA_DIR ?>admin/?component=company&action=add" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <ul style="list-style: none">
                                    <li><a href="http://www.rrk.ir/News/NewsList.aspx" target="_blank"
                                    ...
                                    <li><a href="http://www.ilenc.ir/" target="_blank" style="text-decoration: none">
                                            <h4>جستوجو در سایت اسناد رسمی</h4></a></li>
                                    <li>
                                        <a href="https://www.google.com/search?q=<?php echo  $list['companyInfo']['company_name'] ?>  "
                                    ...
                                    <div class="btn-block mt">
                                        <label class="btn-block btn btn-success uploud-btnProCrop pull-right" for="inputImage" title="Upload image file">
                                            ...
                                            <span class="docs-tooltip pull-right" data-animation="false" title="Import image with Blob URLs">
                                                <span> <i class="fa fa-pencil" aria-hidden="true"></i></i> </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 pull-right control-label rtl"
                                            for="personality_type">نوع شخصیت حقوقی:  <span style='color:red'>*</span></label>
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <select name="personality_type" id="personality_type" data-input="select2" required>
                                            <option></option>
                                            <?php 
                                            foreach ($list['personalityList'] as $key => $value) {
                                                ?>
                                            <option
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 pull-right">
                                        <select required name="state_id" id="province_id" data-input="select2">
                                            <option></option>
                                            <?php 
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 pull-right control-label rtl"
                                            for="registration_date">تاریخ تاسیس تولیدی:  <span style='color:red'>*</span></label>
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                ...
                                <p class="pull-right">
                                    <button type="submit" name="update" id="submit"
                                        ...
                                        <input type="hidden" name="national_id"
                                                value="<?php echo $list['national_id']; ?>">
