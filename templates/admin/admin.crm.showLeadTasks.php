<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function () {
        ...
        var oTable = dataTable.DataTable({
            ...
            "aaSorting": [],
            "ajax": "<?=RELA_DIR?>admin/?component=crm&action=filterLeadTask&status=<?=$list['status'] . $list['admin_id'] ?>",
        });
...
<div class="content-body">
    ...
    <div id="panel-1" class="panel panel-default border-blue">
        <div class="panel-heading bg-blue">
            <h3 class="panel-title rtl"> لیست تسک های لید</h3>
        ...
        <div class="panel-body">
            ...
            <div class="table-responsive table-responsive-datatables">
                <table id="example" class="companyTable table table-striped table-bordered rtl" cellspacing="0" width="100%">
                    ...
                    <th>
                        <select name="search_8" class="search_init form-control" id="status">
