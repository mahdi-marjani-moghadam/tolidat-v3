...
<div class="content-control">
    ...
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24">نام تجاری کمپانی</a></li>
    </ul><!--/control-nav-->
</div><!-- /content-control -->
...
<div class="content-body">
    ...
    <div id="panel-tablesorter" class="panel panel-warning">
        <div class="panel-heading bg-white">
            <h3 class="panel-title rtl">فرم نام تجاری کمپانی</h3>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8">
                                <div class="docs-buttons">
                                    <div class="img-container upload-msg">
                                        <img class="image-banner width" src="<?= (trim($list['image'])!='')? COMPANY_ADDRESS.$list['company_id']."/commercialName/".$list['image']:  RELA_DIR . "templates/admin/assets/img/placeholder.png" ?>" alt="Picture">
                                    </div>
                                    <div class="btn-block mt">
                                        <label class="btn-block btn btn-success uploud-btnProCrop pull-right" for="inputImage-banner" title="Upload image file">
                                            ...
                                            <input class="result-cropBanner" type="hidden" name="commercialNameImage" value="">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p class="pull-right">
                                    ...
                                    <input name="Commercial_name_id" type="hidden" id="company_id" value="<?=$list['Commercial_name_id']?>" />
