<div class="content-control">
  ...
  <ul class="control-nav pull-right">
    <li><a class="rtl text-24"><i class="sidebar-icon fa fa-adn"></i>لیست آدرس های ویرایش شده</a></li>
  </ul><!--/control-nav-->
</div><!-- /content-control -->
...
<div class="content-body">
  ...
  <div id="panel-1" class="panel panel-default border-blue">
    <div class="panel-heading bg-blue">
      <h3 class="panel-title rtl">لیست آدرس های ویرایش شده</h3>
      ...
      <div class="table-responsive table-responsive-datatables">
          ...
          if(isset($list)) {
            foreach ($list as $id => $fields) {
              ?>
              <tr>
                <td><?php echo $fields['Addresses_d_id']; ?></td>
                ...
                <td>
                <a href="<?php echo RELA_DIR?>admin/?component=companyAddresses&action=editDraftCompanyAddress&id=<?php echo $fields['Addresses_d_id']; ?>">بررسی</a> <br/>
