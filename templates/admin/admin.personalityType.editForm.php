                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="text" class="form-control" name="type" id="type" autocomplete="off"/ value="<?= $list['type'] ?>">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <p class="pull-right">
                                        <button type="submit" name="update" id="submit" class="btn btn-icon btn-success rtl">
                                            ...
                                            <input name="Personality_type_id" type="hidden" id="Personality_list_id" value="<?= $list['Personality_type_id'] ?>"/>
