        ...
        <div class="row smallSpace"></div>
          <div class="table-responsive table-responsive-datatables">
            <table id="example" class="companyTable table table-striped table-bordered rtl" cellspacing="0" width="100%">
              ...
              {?>
                  <tr>
                    <td><?php echo $fields['Certification_list_id']; ?></td>
                    <td><?php echo $fields['title']; ?></td>
                    <td><?php echo $fields['description']; ?></td>
                    <td><img height="60" src="<?=COMPANY_ADDRESS.'certification/'. $fields['image'];?>"></td>
                    <td>
                        <a href="<?=RELA_DIR?>admin/?component=certification&action=edit&id=<?php echo $fields['Certification_list_id'];?>">ویرایش</a> <br/>
                        <a href="<?=RELA_DIR?>admin/?component=certification&action=delete&id=<?php echo $fields['Certification_list_id'];?>">حذف</a>
                    </td>
                  </tr>
              <?php
