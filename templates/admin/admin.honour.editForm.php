<div class="content-control">
    ...
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24"><i class="sidebar-icon fa fa-adn"></i> ویرایش افتخارات جدید</a></li>
    </ul><!--/control-nav-->
</div><!-- /content-control -->
<div class="content-body">
    <div id="panel-tablesorter" class="panel panel-warning">
        <div class="panel-heading bg-white">
            <h3 class="panel-title rtl">فرم ویرایش افتخارات</h3>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <textarea class="form-control fullFix" name="description" id="description" required><?= $list['list']['description'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-8">
                                    <div class="docs-buttons">
                                        <div class="img-container upload-msg">
                                            <img class="image-banner width" src="<?= (trim($list['honour']['image'])!='')? COMPANY_ADDRESS.$list['honour']['company_id']."/honour/".$list['honour']['image']:  RELA_DIR . "templates/admin/assets/img/placeholder.png" ?>" alt="Picture">
                                        </div>
                                        <div class="btn-block mt">
                                            <label class="btn-block btn btn-success uploud-btnProCrop pull-right" for="inputImage-banner" title="Upload image file">
                                                ...
                                                <input class="result-cropBanner" type="hidden" name="honourImage" value="">
                            ...
                            <div class="col-md-12">
                                <p class="pull-right margin-right">
                                    <button type="submit" name="update" id="submit"
                                        ...
                                        <input name="Honour_id" type="hidden" id="Honour_id" value="<?= $list['honour_id'] ?>"/>
