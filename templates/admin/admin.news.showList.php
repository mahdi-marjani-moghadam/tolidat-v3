...
<div class="content-body">
    ...
    <div class="panel-body">
        <div class="pull-right">
            <a href="<?php echo RELA_DIR?>admin/?component=news&action=addNews" class="btn btn-primary btn-sm btn-icon text-13"><i class="fa fa-plus"></i> افزودن خبر جدید</a>
        </div>
          ...
          if(isset($list['list'])) {
            foreach ($list['list'] as $id =>$fields) {
              ...
              <tr>
                ...
                <td><a href="<?php echo RELA_DIR?>admin/?component=news&action=editNews&id=<?php echo $fields['News_id']; ?>">ویرایش</a>
                  <a href="<?php echo RELA_DIR?>admin/?component=news&action=deleteNews&id=<?php echo $fields['News_id']; ?>">حذف</a> </td>
