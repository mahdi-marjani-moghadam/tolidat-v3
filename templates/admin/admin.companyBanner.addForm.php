...
<div class="content-control">
    ...
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24">فرم بنر<i class="sidebar-icon fa fa-info"></i></a></li>
    </ul><!--/control-nav-->
</div><!-- /content-control -->
...
<div class="content-body">
    <div id="panel-tablesorter" class="panel panel-warning">
        <div class="panel-heading bg-white">
            <h3 class="panel-title rtl">بنر</h3><br>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-8  center-block">
                    <form name="queue" id="queue" role="form" data-validate="form" class="form-horizontal"
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <div class="row noMargin">
                                        <label class="col-xs-12 col-sm-2 col-md-2 pull-right control-label rtl" for="xImagePath">تصویر:</label>
                                        <div class="col-xs-12 col-sm-12 col-md-10">
                                            <div class="docs-buttons">
                                                <div class="img-container">
                                                    <img class="width image-banner" src="<?= (trim($list['image'])!='')? COMPANY_ADDRESS.$list['company_id']."/banner/".$list['image']:  RELA_DIR . "templates/admin/assets/img/placeholder.png" ?>" alt="Picture">
                                                </div>
                                                <div class="btn-block mt">
                                                    <label class="btn-block btn btn-success uploud-btnProCrop pull-right" for="inputImage-banner" title="Upload image file">
                                                        ...
                                                        <input class="result-cropBanner" type="hidden" name="bannerImage" value="">
                        ...
                        <!--                              <i class="fa fa-plus"></i> افزودن لگو-->
                        <!--                          </a>-->
                        <!--                      </div>-->
                        <!--                  </div>-->
                        <!--              </div>-->
