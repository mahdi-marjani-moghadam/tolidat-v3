...
<div class="content-control">
  ...
  <ul class="control-nav pull-right">
    <li><a class="rtl text-24"><i class="sidebar-icon fa fa-adn"></i>لیست مجوز های ویرایش شده</a></li>
  </ul><!--/control-nav-->
</div><!-- /content-control -->
...
<div class="content-body">
  ...
  <div id="panel-1" class="panel panel-default border-blue">
    <div class="panel-heading bg-blue">
      <h3 class="panel-title rtl">لیست مجوز های ویرایش شده</h3>
          ...
          if(isset($list['list'])) {
            foreach ($list['list'] as $id =>$fields) {
              ...
              <tr>
                ...
                <td dir="ltr" align="center"> <img height="60px" src="<?=COMPANY_ADDRESS.$fields['company_id']."/licence/".$fields['image']?>"/> </td>
                <td>
                  <a href="<?=RELA_DIR?>admin/?component=licence&action=editDraftLicence&id=<?php echo $fields['Licence_id']; ?>">بررسی</a> </td>
              </tr>
              <?
            }
          }
