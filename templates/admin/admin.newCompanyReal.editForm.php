                ...
                <div class="col-xs-12 col-sm-12 col-md-8  center-block">
                    <form name="queue" id="queue" role="form" data-validate="form" class="form-horizontal" autocomplete="off" novalidate="novalidate" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <?php if (isset($list['string_link'])) { ?>
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-4 col-md-4 pull-right control-label rtl" for="editor_family">لینک کمپانی مشابه در تولیدات:</label>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 col-md-4 pull-right control-label rtl" for="mobile">شماره تماس نماینده:</label>
                                    <div class="col-xs-12 col-sm-8 col-md-8 pull-right">
                                        <input type="text" class="form-control" name="editor_mobile" id="editor_mobile" required value="<?php echo  $list['editorInfo']['mobile'] ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="docs-buttons">
                                                    <div class="img-container upload-msg">
                                                        <img class="image-crop" src="<?php echo (isset($list['logo']['image'])
                                                                                            ? COMPANY_ADDRESS . $list['logo']['company_id'] . "/logo/" . $list['logo']['image']
                                                                                            : '/templates/' . CURRENT_SKIN . '/assets/images/placeholder.png'); ?>" alt="Picture">
                                                    </div>
                        ...
                        <div id="LicenceBox">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8 pull-right">
                                            <select name="licence_type" id="licence_type" data-input="select2">
                                                <option></option>
                                                <?php foreach ($list['licence'] as $key => $value) { ?>
                                                    <option value="<?php echo  $value['Licence_list_id'] ?>" <?php echo ($list['licenceInfo']['licence_type'] == $value['Licence_list_id']) ? "selected" : '' ?>> <?php echo  $value['name'] ?>
                                                    </option>
                                                <?php } ?>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-4  col-md-4 pull-right control-label rtl" for="licence_number">شماره جواز:</label>
                                        <div class="col-xs-12 col-sm-8  col-md-8  pull-right">
                                            <input type="text" class="form-control" name="licence_number" id="licence_number" value="<?php echo  $list['licenceInfo']['licence_number'] ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-4  col-md-4 pull-right control-label rtl" for="licence_description">فعالیت جواز:</label>
                                        <div class="col-xs-12 col-sm-8  col-md-8  pull-right">
                                            <input type="text" class="form-control" name="licence_description" id="licence_description" value="<?php echo  $list['licenceInfo']['description'] ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-4 col-md-4 pull-right control-label rtl" for="name">نام صاحب جواز:</label>
                                        <div class="col-xs-12 col-sm-8 col-md-8 pull-right">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-4 col-md-4 pull-right control-label rtl" for="family">نام خانوادگی صاحب جواز:</label>
                                        <div class="col-xs-12 col-sm-8 col-md-8 pull-right">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="national_code">کد ملی صاحب جواز:</label>
                                        <div class="col-xs-12 col-sm-8 pull-right">
                                            <input type="text" class="form-control" name="national_code" id="national_code" value="<?php echo  $list['licenceInfo']['national_code'] ?>" maxlength="10" minlength="10">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-4 col-md-4 pull-right control-label rtl" for="exporter_refrence">مرجع تایید جواز:</label>
                                        <div class="col-xs-12 col-sm-8 col-md-8 pull-right">
                                            <input type="text" class="form-control" name="exporter_refrence" id="exporter_refrence" required value="<?php echo  $list['licenceInfo']['exporter_refrence'] ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="issuence_date">تاریخ صدور جواز:</label>
                                        <div class="col-xs-12 col-sm-8 pull-right">
                                            <input type="text" class="form-control date" name="issuence_date" id="issuence_date" value="<?php echo  $list['licenceInfo']['issuence_date'] ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="expiration_date">تاریخ انقضا جواز:</label>
                                        <div class="col-xs-12 col-sm-8 pull-right">
                                            <input type="text" class="form-control date" name="expiration_date" id="expiration_date" value="<?php echo  $list['licenceInfo']['expiration_date'] ?>" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <div class="docs-buttons">
                                        <div class="img-container">
                                            <img class="width image-banner" src="<?php echo (trim($list['licenceInfo']['image']) != '') ? COMPANY_ADDRESS . $list['licenceInfo']['company_id'] . "/licence/" . $list['licenceInfo']['image'] :  RELA_DIR . "templates/admin/assets/img/placeholder.png" ?>" alt="Picture">
                                        </div>
                                        <div class="btn-block mt">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 col-md-4 pull-right control-label rtl" for="description">فعالیت شرکت:</label>
                                    <div class="col-xs-12 col-sm-8 col-md-8 pull-right">
                                    <select name="personality_type" id="personality_type" data-input="select2" required>
                                        ...
                                        <!-- <input type="text" class="form-control" name="description" id="description" required value="< ?php echo  $list['companyInfo']['description'] ?>"> -->
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 col-md-4 pull-right control-label rtl" for="maneger_name">نام مدیر:</label>
                                    <div class="col-xs-12 col-sm-8 col-md-8 pull-right">
                                        <input type="text" class="form-control" name="maneger_name" id="maneger_name" required value="<?php echo  $list['licenceInfo']['name'] . " " . $list['licenceInfo']['family'] ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="email" class="form-control" name="email" id="email" value="<?php echo  $list['emailInfo']['email'] ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <select name="reference_type" id="reference_type" data-input="select2">
                                            <option value="1" <?php echo ($list['phoneInfo']['reference_type'] == '1') ? "selected" : '' ?>>
                                                روزنامه رسمی
                                            </option>
                                            <option value="2" <?php echo ($list['phoneInfo']['reference_type'] == '2') ? "selected" : '' ?>>
                                                سایت
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="reference_value">توضیحات مرجع تایید تلفن:</label>
                                    <div class="col-xs-12 col-sm-8 pull-right">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="search-box boxBorder categoryContainer">
                                    <div class="search-box-header edit-primary-form whiteBg">
                                        ...
                                        <p>دسته بندی ها</p>
                                        <i class="fa fa-question list-question" aria-hidden="true" data-placement="top" data-trigger="hover" data-toggle="popover" title="" data-content="لطفا نام خود را به صورت کامل همراه با پسوند و پیشوند وارد کنید" data-original-title="نام"></i>
                                    </div>
