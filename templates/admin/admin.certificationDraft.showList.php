...
<div class="content-control">
    ...
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24"><i class="sidebar-icon fa fa-adn"></i> لیست گواهی های ویرایش شده</a></li>
    </ul><!--/control-nav-->
</div><!-- /content-control -->
...
<div class="content-body">
    ...
    <div id="panel-1" class="panel panel-default border-blue">
        <div class="panel-heading bg-blue">
            <h3 class="panel-title rtl">لیست گواهی های ویرایش شده</h3>
                ...
                <table id="example" class="companyTable table table-striped table-bordered rtl" cellspacing="0"
                    ...
                    if (isset($list['list'])) {
                        foreach ($list['list'] as $id => $fields) {
                            ?>
                            <tr>
                                <td><?php echo $fields['Certification_d_id']; ?></td>
                                ...
                                <td>
                                    <a href="<?= RELA_DIR ?>admin/?component=certification&action=editDraftCertification&id=<?php echo $fields['Certification_d_id']; ?>">بررسی</a>
                                </td>
                            </tr>
                            <?php
