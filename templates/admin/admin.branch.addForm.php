...
<div class="content-body">
    <div id="panel-tablesorter" class="panel panel-warning">
        <div class="panel-heading bg-white">
            <h3 class="panel-title rtl">اضافه کردن شعبه: </h3>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8 pull-right">
                                    <input type="text" class="form-control" name="branch_name" id="branch_name" autocomplete="off" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8 pull-right">
                                    <input type="text" class="form-control" name="maneger_name" id="maneger_name" autocomplete="off" required>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <p class="pull-right">
                                <button type="submit" name="update" id="submit" class="btn btn-icon btn-success rtl">
                                    ...
                                    <input type="hidden" name="company_id" id="company_id" value="<?php echo $list['company_id']; ?>"/> ثبت
                                    <input type="hidden" name="branch_id" id="branch_id" value="<?php echo $list['branch_id']; ?>"/> ثبت
                                </button>
