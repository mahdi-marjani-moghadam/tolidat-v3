...
<div class="content-control">
    ...
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24">فرم ویرایش بنر<i class="sidebar-icon fa fa-info"></i></a></li>
    </ul><!--/control-nav-->
</div><!-- /content-control -->
<div class="content-body">
    <div id="panel-tablesorter" class="panel panel-warning">
        <div class="panel-heading bg-white">
            <h3 class="panel-title rtl">فرم ویرایش بنر</h3>
                                        ...
                                        <div class="docs-buttons">
                                            <div class="img-container">
                                                <img class="width image-banner"
                                                     src="<?= (trim($list['image'])!='')? COMPANY_ADDRESS.$list['company_id']."/banner/".$list['image']:  RELA_DIR . "templates/admin/assets/img/placeholder.png" ?>"
                                                     alt="Picture">
                                            </div>
                                            <div class="btn-block mt">
                                                <label class="btn-block btn btn-success uploud-btnProCrop pull-right"
                                                    ...
                                                    <input class="result-cropBanner" type="hidden" name="bannerImage"
                                                           value="">
