...
<div class="content-control">
    ...
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24"><i class="sidebar-icon fa fa-archive"></i> لیست فاکتورهای پرداخت نشده </a></li>
    </ul><!--/control-nav-->
</div><!-- /content-control -->
...
<div class="content-body">
    ...
    <div id="panel-1" class="panel panel-default border-blue">
        <div class="panel-heading bg-blue">
            ...
            <h3 class="panel-title rtl">لیست فاکتورهای پرداخت نشده </h3>
                    ...
                    <?php if (isset($list['list'])): ?>
                        <?php foreach ($list['list'] as $id => $fields): ?>
                            <tr>
                                ...
                                <td><a href="<?php echo RELA_DIR ?>admin/?component=company&action=showDetail&id=<?php echo $fields['company_id']; ?>"><?php echo $fields['company_name']; ?></a></td>
                                <td><?php echo $fields['packagetype']; ?></td>
                                <td><?php echo $fields['price']; ?></td>
                                <td><?php echo $fields['total_price']; ?></td>
                                <td><?php echo 'پرداخت نشده' ?></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
                    </tbody>
