<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function () {
        ...
        var oTable = dataTable.DataTable({
            ...
            "aaSorting": [],
            "ajax": "<?=RELA_DIR?>admin/?component=onlinePayment&action=searchAllPay",
        });
...
<div class="content-control">
    ...
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24"><i class="sidebar-icon fa fa-adn"></i>لیست پرداخت های آنلاین</a></li>
    </ul>
    <!--/control-nav-->
</div>
<!-- /content-control -->
<div class="content-body">
    ...
    <div id="panel-1" class="panel panel-default border-blue">
        <div class="panel-heading bg-blue">
            <h3 class="panel-title rtl ">لیست پرداخت های آنلاین</h3>
        ...
        <div class="panel-body">
            ...
            <div class="table-responsive table-responsive-datatables">
                <table id="example" class="companyTable table table-striped table-bordered rtl" cellspacing="0"
                    ...
                    <th><select name="search_8" class="search_init form-control" id="search_9">
                            <option value="">همه</option>
                            <option value="0">پرداخت نشده</option>
                            <option value="5">پرداخت شده</option>
                        </select>
                    </th>
                    <th><input type="text" name="search_9" class="date search_init form-control"/></th>
                    </tfoot>
                </table>
            </div>
        </div>
