                    ...
                    <form name="queue" id="queue" role="form" data-validate="form" class="form-horizontal"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                <div class="form-group">
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <select name="state" class="select-phone-state" title="">
                                            <option value="0" <?= ($list['state'] == 'داخلی') ? 'selected' : '' ?>>داخلی</option>
                                            <option value="1" <?= ($list['state'] == 'الی') ? 'selected' : '' ?>>الی</option>
                                            <option value="2" <?= ($list['state'] == '') ? 'selected' : '' ?>> </option>
