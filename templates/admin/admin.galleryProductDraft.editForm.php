<div class="content-control">
    ...
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24">گالری محصول</a></li>
    </ul><!--/control-nav-->
</div><!-- /content-control -->
...
<div class="content-body">
    <div id="panel-tablesorter" class="panel panel-warning">
        <div class="panel-heading bg-white">
            <h3 class="panel-title rtl">گالری محصول</h3>
                ...
                <div class="col-xs-12 col-sm-12 col-md-8  center-block">
                    <form name="queue" id="queue" role="form" data-validate="form" class="form-horizontal" novalidate="novalidate" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="docs-buttons">
                                                <div class="img-container upload-msg">
                                                    <img class="image-crop" src="<?= (trim($list['image'])!='') ? COMPANY_ADDRESS.$list['company_id']."/product/gallery/".$list['image']:  RELA_DIR . "templates/admin/assets/img/placeholder.png" ?>" alt="Picture">
                                                </div>
                                                <div class="btn-block mt">
                                                    <label class="btn-block btn btn-success uploud-btnProCrop pull-right" for="inputImage" title="Upload image file">
                                                        ...
                                                        <input class="result-crop" type="hidden" name="uploadImage" value="">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <label class="col-xs-12 pull-right control-label rtl" for="admin_description">توضیحات مدیر:</label>
                                    <div class="col-xs-12 pull-right">
                                        <textarea name="admin_description" id="admin_description" cols="100" rows="5"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
