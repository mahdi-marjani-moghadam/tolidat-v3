            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-8  center-block">
                        <form name="addCompany" id="addCompany" role="form" data-validate="form" class="form-horizontal" autocomplete="off" novalidate="novalidate" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <p class="pull-right">
                                        ...
                                        <button type="submit" class="btn btn-icon btn-success rtl">
                                            <i class="fa fa-plus"></i> اضافه کردن
                                        </button>
