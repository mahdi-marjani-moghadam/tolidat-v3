                    ...
                    <form name="queue" id="queue" role="form" data-validate="form" class="form-horizontal"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 pull-right control-label rtl"
                                            for="brif_description">توضیحات مختصر:</label>
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <div class="input-group" dir="ltr">
                                            <input name="image" type="text" class="form-control" id="xImagePath"
                                                    value="<?= $list['image']; ?>"/> <span class="input-group-btn">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <select name="category_id[]" id="category_id" data-input="select2" multiple>
                                            <? foreach ($list['category'] as $category_id => $value): ?>
                                                <option <?php echo $value['Category_id'] == $list['category_id'] ? 'selected' : '' ?>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="text" class="form-control set-font-latin ltr" name="url" id="url" value="<?= $list['url'] ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="url">مرتب سازی</label>
                                    <div class="col-xs-12 col-sm-8 pull-right">
