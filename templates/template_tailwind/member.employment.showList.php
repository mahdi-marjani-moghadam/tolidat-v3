...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="holder-title center-block">
            <span data-intro=" در این قسمت هرگونه فرصت شغلی اعم از فرصت شغلی تولید و ... را درج نمایید." class="title-pro">فرصت های شغلی</span> <span class="betaVersion">(نسخه آزمایشی)</span>
            <button data-intro="اضافه کردن فرصت شغلی" type="button" class="i-add btn btn-sm pull-left add-btnPro" data-toggle="modal" data-target="#myModal2">
...
<div class="row add-employment">
    <?php if (isset($list['list']) && count($list['list'])) : ?>
        <?php foreach ($list['list'] as $id => $fields) : ?>
            <div class="col-xs-12 col-sm-6 col-md-4 pull-right mb5 remove-employment" data-value="<?php echo  $fields['Employment_id'] ?>">
                    ...
                    <h3>
                        <div class="kebabMenu">
                            ...
                            <ul class="kebab-menu-content roundCorner boxBorder">
                                <li><a class="link-edit" data-value="<?php echo  $fields['Employment_id'] ?>"><i class="fa fa-pencil" aria-hidden="true"></i><span>ویرایش </span></a>
                                </li>
                                <li><a class="link-trash" data-value="<?php echo  $fields['Employment_id'] ?>"><i class="fa fa-trash-o" aria-hidden="true"></i><span>حذف</span></a></li>
                            </ul>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 pull-right">
                                <div class="form-group mb">
                                    ...
                                    <input name="history" type="text" tabindex="9" class="form-control" id="history" data-error="لطفا سابقه خود را وارد نمایید">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 pull-left">
                                <div class="form-group mb">
                                    ...
                                    <input name="minSallary" type="text" tabindex="10" class="form-control money" id="minSallary" data-error="لطفا حداقل حقوق خود را وارد نمایید" pattern="^[0-9]{3,}$">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 pull-right">
                                <div class="form-group mb">
                                    ...
                                    <input name="maxSallary" type="text" tabindex="11" class="form-control money" id="maxSallary" data-error="لطفا حداکثر حقوق خود را وارد نمایید" pattern="^[0-9]{3,}$">
                                    <span class="currency-span">تومان</span>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 pull-left">
                                <div class="form-group mb">
                                    <input name="skill" type="text" data-error="لطفا مهارت خود را وارد نمایید" placeholder="مهارت خود را وارد نمایید. (بعد از هر کلمه دکمه Enter را بزنید.)" data-role="tagsinput" tabindex="8" id="skill">
                                </div>
                ...
                <form id="editEmployment" class="form employment" enctype="multipart/form-data" method="post" data-toggle="validator" novalidate="novalidate">
                    <div class="row noMargin">
                        <div class="col-xs-12 col-sm-6 col-md-6 pull-right">
                            <div class="form-group mb">
                                <label for="title">عنوان</label>
                                <input data-minWord="6" name="title" type="text" class="form-control progressText" id="title" required tabindex="1" data-error="لطفا نام عنوان خود را وارد نمایید">
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 pull-left">
                            <div class="form-group mb">
                                <label for="description">توضیحات</label>
                                <textarea data-minWord="6" name="description" class="form-control progressText" tabindex="2" id="description"></textarea>
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 pull-right">
                            <div class="form-group mb full-date-picker">
                                <label for="startDate">تاریخ شروع</label>
                                <input name="startDate" type="text" class="form-control datePicker set-font-latin" id="startDate" required tabindex="3" data-error="لطفا تاریخ شروع خود را وارد نمایید">
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 pull-left">
                            <div class="form-group mb full-date-picker">
                                <label for="expireDate">تاریخ انقضا </label>
                                <input name="expireDate" type="text" tabindex="4" class="form-control datePicker set-font-latin" id="expireDate" required data-error="لطفا تاریخ انقضا خود را وارد نمایید">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xs-8 col-sm-4 col-md-4 pull-right">
                            <div class="form-group mb">
                                <label for="contactPhone">شماره تماس</label>
                                <input name="contactPhone" type="text" pattern="^[0-9]{3,}$" maxlength="8" class="form-control" id="contactPhone" required tabindex="5" data-error="لطفا شماره تماس خود را وارد نمایید">
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 pull-left">
                            <div class="form-group mb">
                                <label for="contactEmail">ایمیل</label>
                                <input name="contactEmail" type="email" class="form-control text-left ltr" id="contactEmail" tabindex="6" required data-error="لطفا ایمیل خود را وارد نمایید">
                            </div>
                    ...
                    <div class="more-employment more-employment-edit">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 pull-right">
                                <div class="form-group mb">
                                    <label for="history">سابقه</label>
                                    <input name="history" type="text" class="form-control" tabindex="9" id="history" data-error="لطفا سابقه خود را وارد نمایید">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 pull-left">
                                <div class="form-group mb">
                                    <label for="minSallary">حداقل حقوق</label>
                                    <input name="minSallary" type="text" class="form-control money" tabindex="10" id="minSallary" data-error="لطفا حداقل حقوق خود را وارد نمایید" pattern="^[0-9]{3,}$">
                                    <span class="currency-span">تومان</span>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 pull-right">
                                <div class="form-group mb">
                                    <label for="maxSallary"> حداکثر حقوق</label>
                                    <input name="maxSallary" type="text" class="form-control money" tabindex="11" id="maxSallary" data-error="لطفا حداکثر حقوق خود را وارد نمایید" pattern="^[0-9]{3,}$">
                                    <span class="currency-span">تومان</span>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 pull-left">
                                <div class="form-group mb">
                                    <input name="skill" type="text" tabindex="8" id="skill" data-error="لطفا مهارت خود را وارد نمایید" placeholder="مهارت خود را وارد نمایید. (بعد از هر کلمه دکمه Enter را بزنید.)" data-role="tagsinput">
                                </div>
...
<script>
    ...
    $(function() {
        ...
        function editItem(dataID) {
            ...
            $.post('/member/employment/editAjax/', {
                id: dataID
            }, function(data) {
                var result = $.parseJSON(data),
