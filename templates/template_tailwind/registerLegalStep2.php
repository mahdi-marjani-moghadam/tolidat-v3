                            ...
                            <div class="grid grid-cols-12 gap-6">
                                ...
                                <div class="col-span-12 sm:col-span-6">
                                    <div class="relative">
                                        ...
                                        <input name="family" 
                                            type="text" 
                                            value="<?php echo $list['data']['family'] ?>" 
                                            class="mt-1 focus:to-tolidatColor focus:border-tolidatColor focus-visible:ring-2 focus-visible:ring-tolidatColor block w-full shadow-sm sm:text-sm border border-gray-300 rounded-md px-3 py-2                form-control set-font-latin" 
                                            id="family" 
                                            maxlength="50" 
                                            minlength="1" 
                                            oninvalid="setCustomValidity('لطفا نام خانوادگی را وارد نمایید')"
                                            oninput="setCustomValidity('')"
                                            tabindex="2" 
                                            required>
                                    </div>
                                ...
                                <div class="col-span-12 sm:col-span-6">
                                    <div class="relative">
                                        ...
                                        <input name="phone" 
                                            type="text" 
                                            value="<?php echo  $list['data']['phone'] ?>" 
                                            ...
                                            maxlength="11" 
                                            tabindex="3" 
                                            oninvalid="setCustomValidity('لطفا شماره موبایل صحیح جهت دریافت کد فعال سازی وارد کنید.')"
                                            oninput="setCustomValidity('')"
                                            dir="ltr"
                                            required>
                                    </div>
