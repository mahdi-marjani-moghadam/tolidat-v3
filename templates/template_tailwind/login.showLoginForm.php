            ...
            <div class="flex flex-col p-6         container-login-validator">
                ...
                <div class="mt-16 container-logo-input container-Legal">
                    <form class="" 
                        ...
                        <div class="relative">
                            <label for="username" class="block text-sm font-medium text-gray-700          validation">نام کاربری</label>
                            <input name="username" 
                                id="username" 
                                type="text" 
                                value="<?php echo  $list['data']['company_name'] ?>"
                        ...
                        <div class="relative mt-4">
                            <label for="password" class="block text-sm font-medium text-gray-700          validation">گذرواژه</label>
                            <input name="password" 
                                id="password" 
                                type="password" 
                                ...
                                data-error="گذرواژه را وارد کنید"
                                tabindex="2" 
                                required>
                        </div>

                        <button type="submit" 
                                class="mt-4 w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-green-400 hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-600                       btn btn-success btn-sm register-button reg-btn-n show-more">
                            ورود به سیستم
                        </button>
                    ...
                    <a class="link-forget block text-center mt-8" href="<?php echo RELA_DIR . "login/getUsername"?>">رمز خود را فراموش کرده اید؟</a>
                </div>
            </div>
        </div>
        ...
        <div class="hidden lg:col-span-2 xl:col-span-3 md:flex content-end items-end justify-center          container-login-img pull-right">
            <div class="container-account">
                ...
                <div class="mt-4 mb-10          form-group">
                    <a class="w-52 flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-tolidatColor           btn btn-default btn-block btn-account" 
                       href="<?php echo RELA_DIR . "register" ?>">
                        ثبت نام
                    </a>
                </div>
            </div>
