                            ...
                            <div class="grid grid-cols-12 gap-6">
                                ...
                                <div class="col-span-12 sm:col-span-6">
                                    <div class="relative">
                                        ...
                                        <input name="company_name" type="text" value="<?php echo  $list['data']['company_name'] ?>" class="mt-1 focus:to-tolidatColor focus:border-tolidatColor focus-visible:ring-2 focus-visible:ring-tolidatColor block w-full shadow-sm sm:text-sm border border-gray-300 rounded-md px-3 py-2                form-control set-font-latin" id="company_name" maxlength="50" minlength="1" tabindex="1" autofocus oninvalid="setCustomValidity('لطفا نام کامل ثبتی مجموعه خود را وارد نمائید')" oninput="setCustomValidity('')" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-12 sm:col-span-6">
                                    <div class="relative">
                                        ...
                                        <input name="registration_number" type="number" value="<?php echo  $list['data']['registration_number'] ?>" class="text-left pl-7 mt-1 focus:to-tolidatColor focus:border-tolidatColor focus-visible:ring-2 focus-visible:ring-tolidatColor block w-full shadow-sm sm:text-sm border border-gray-300 rounded-md px-3 py-2                form-control set-font-latin" id="registration_number" maxlength="50" minlength="1" tabindex="2" oninvalid="setCustomValidity('لطفاشماره ثبت مربوط به مجموعه خود را وارد نمائید')" oninput="setCustomValidity('')" dir="ltr" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-12 sm:col-span-6">
                                    <div class="relative">
                                        ...
                                        <input name="registration_date" type="text" value="<?php echo  $list['data']['registration_date'] ?>" class="datePicker mt-1 focus:to-tolidatColor focus:border-tolidatColor focus-visible:ring-2 focus-visible:ring-tolidatColor block w-full shadow-sm sm:text-sm border border-gray-300 rounded-md px-3 py-2                form-control set-font-latin" id="registration_date" maxlength="11" tabindex="3" oninvalid="setCustomValidity('لطفا تاریخ تأسیس مجموعه را انتخاب نمایید')" valid="setCustomValidity('')" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-12 sm:col-span-6">
                                    <div class="relative">
                                        ...
                                        <input name="maneger_name" type="text" value="<?php echo  $list['data']['maneger_name'] ?>" class="mt-1 focus:to-tolidatColor focus:border-tolidatColor focus-visible:ring-2 focus-visible:ring-tolidatColor block w-full shadow-sm sm:text-sm border border-gray-300 rounded-md px-3 py-2                form-control set-font-latin" id="coordinator_name" tabindex="4" minlength="3" oninvalid="setCustomValidity('نام کامل ثبتی مدیرعامل مجموعه را وارد نمائید')" oninput="setCustomValidity('')" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-12 sm:col-span-6">
                                    <div class="relative">
                                        ...
                                        <select name="personality_type" id="personality_type" class="form-control w-full rounded-none border-r-0 border-t-0 border-l-0 mt-1" tabindex="6" oninvalid="setCustomValidity('لطفا نوع شخصیت حقوقی را انتخاب نمایید')" oninput="setCustomValidity('')" required>
