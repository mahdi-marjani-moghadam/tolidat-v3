...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo RELA_DIR ?>templates/template_en/assets/image/favicon.png">
    <link rel="stylesheet" href="<?php echo RELA_DIR ?>templates/template_en/assets/css/normalize.css">
    <link rel="stylesheet" href="<?php echo RELA_DIR ?>templates/template_en/assets/css/bootstrap-tagsinput.min.css">
    <link rel="stylesheet" href="<?php echo RELA_DIR ?>templates/template_en/assets/css/jquery.mmenu.all.css" />
    <link rel="stylesheet" href="<?php echo RELA_DIR ?>templates/template_en/assets/css/introjs.css">
    <link rel="stylesheet" href="<?php echo RELA_DIR ?>templates/template_en/assets/css/introjs-rtl.css">
    <link rel="stylesheet" href="<?php echo RELA_DIR ?>templates/template_en/assets/css/profile-style.css">
    <link rel="stylesheet" href="<?php echo RELA_DIR ?>templates/template_en/assets/css/responsive.css">
    <link rel="Stylesheet" href="<?php echo RELA_DIR ?>templates/template_en/assets/css/main.css">
    <link rel="Stylesheet" href="<?php echo RELA_DIR ?>templates/template_en/assets/css/cropper.css">
    <link rel="stylesheet" href="<?php echo RELA_DIR ?>templates/template_en/assets/css/styleprice.css">
    ...
    <script src="<?php echo RELA_DIR ?>templates/template_en/assets/js/modernizr.custom.js"></script>
    <script>
                        ...
                        <div class="navbar-brand">
                            <div class="profile-logo">
                                <a href="<?php echo RELA_DIR; ?>" name="logo" title="لوگوی پروفایل تولیدات">
                                    <img data-step="1" data-intro="لوگو" src="<?php echo RELA_DIR . 'templates/' . CURRENT_SKIN; ?>/assets/image/tolidat-logo.png" alt="لوگوی پروفایل تولیدات">
                                </a>
                            </div>
                                                        ...
                                                        <div class="details">
                                                            <a href="/profile/notification/<?php echo $value['Notification_id']; ?>">
                                                                <span class="title"><?php echo $value['msg'] ?>
                                                                    <span class="date"><?php echo convertDate(substr($value['date'], 0, 10)) ?></span>
                                                                </span> </a>
                                                        </div>
                                                    </li>
                                                <?php endforeach; ?>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-10 col-md-10 pull-right">
                    <div class="cont-banerPro mt center-block boxBorder">
                        <!--banner-->
                        <div class="img-banerPro roundCorner Baner" style="background: url('<?php echo  $banner['companyBanner'] ?>')  no-repeat center / cover   ;">
                            <div class="container-banner-crop roundCorner transition">
                                <img class="roundCorner image-banner my-imgcrop-banner" src="<?php echo (!empty($banner['companyBannerDraft'])) ? (COMPANY_ADDRESS . $information_company['companyId'] . '/banner/' . $banner['companyBannerDraft']) : ($banner['companyBanner']) ?>">
                                                    ...
                                                    <div class="grid">
                                                        ...
                                                        <div class="docs-buttons">
                                                            <div class="img-container">
                                                                <img class="width image-banner img-cropper" src="<?php echo (isset($value['image']) ? COMPANY_ADDRESS . $value['Company_id'] . "/logo/" . $value['image'] : '/templates/' . CURRENT_SKIN . '/assets/image/placeholder1.png'); ?>" alt="Picture">
                                                            </div>
                        ...
                        <div class="holder-pic roundCorner transition crop" id="crop-avatar">
                            <div class="my-imgcrop-profile">
                                <div class="my-imgcrop-logo">
                                    <img src="<?php echo ($information_company['companyLogoDraft'] ? COMPANY_ADDRESS . $information_company['companyId'] . '/logo/' . $information_company['companyLogoDraft'] : DEFULT_LOGO_ADDRESS); ?>" class="boxBorder roundCorner fullWidth" alt="<?php echo (strlen($value['title']) ? $value['title'] : '-'); ?>">
                                        ...
                                        <div class="modal-body">
                                            <div class="docs-buttons">
                                                <div class="img-container upload-msg register-crop">
                                                    <img class="width image-crop img-cropper" src="<?php echo (isset($information_company['companyLogoDraft']) ? COMPANY_ADDRESS . $value['Company_id'] . "logo/" . $information_company['companyLogoDraft'] : '/templates/' . CURRENT_SKIN . '/assets/image/placeholder.png'); ?>" alt="Picture">
                                                </div>
                                                <div class="btn-block">
            ...
            var deleteAction = {
                "deleteBanner": function() {
                    $.get(baseURL + 'member/companyBanner/delete', function(data) {
                        ...
                        $('.my-imgcrop-banner').attr('src', baseURL + 'templates/template_en/assets/image/placeholder1.png');
