    ...
    <div class="lg:col-span-2">
        ...
        <div class="leading-relaxed">
            <div class="border-2 my-4 rounded bg-gray-50">
                <h2 class="p-3 border-b bg-gray-200"><i class="fa fa-info-circle"></i> About <?php echo $list['side']['list']['company_name'] ?></h2>
                    ...
                    ?>
                            <div class="grid grid-cols-1 sm:grid-cols-2  gap-1 mt-4">
                                <div class="border rounded p-2 bg-white ">
                                    <h2 class="text-tolidatColor" title="Email">Email</h2>
                                    <?php
                                ...
                                <div class="border rounded p-2 bg-white">
                                    <h2 class="text-tolidatColor" title="Address">Address</h2>
                                    <?php
                                ...
                                <div class="border rounded p-2 bg-white">
                                    <h2 class="text-tolidatColor" title="Url ">Url </h2>
                                    <?php
                                ...
                                <div class="border rounded p-2 bg-white ">
                                    <h2 class="text-tolidatColor" title="Phone">Phone</h2>
                                    <?php
        ...
        <?php if (isset($list['side']['product_list'])) : ?>
            <!---------------------- محصولات ---------------------->
            <div class="border-2 my-4 rounded bg-gray-50">
                <h2 class="border-b p-3 bg-gray-200 ">Products/Services</h2>
                ...
                <div id="products" class="px-3 pt-3 pb-2 text-header searchBox1 bestProduct  fullWidth container-product-Grouping productGrid">
                    <div class="content">
                                    ...
                                    <div class="product-group border p-2 rounded  bg-white ">
                                        ...
                                        <div class="product-content pull-right rtl">
                                            ...
                                            <div class="tag rtl text-right  text-xs px-2 -mx-2 bg-gray-200 p-1 mb-2 leading-7 truncate ">
                                                Category : <span class="bg-white border-tolidatColor border rounded-full px-2"><?php echo  $fields['category_name'] ?></span>
                                            </div>
                        ...
                        <a href="<?php echo RELA_DIR . "product/all/" . $list['side']['list']['Company_id'] ?>" class="inline-block mt-2 py-1 px-2 border border-transparent text-sm font-medium rounded-md text-white bg-tolidatColor hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Product list </a>
                    </div>
                </div>
            </div>
        <?php endif; ?>
            ...
            <?php if (isset($list['side']['history_list'])) : ?>
                <?php if (count($list['side']['history_list']) > 1) : ?>
                    <div id="history" class="bg-gray-50 border-2 rounded">
                        <h2 class="p-3 border-b bg-gray-200">Records and clients</h2>
                        ...
                        <div class="px-3 pb-2">
                            <a href="<?php echo RELA_DIR . "history/all/" . $list['side']['list']['Company_id'] ?>" class="inline-block py-1 px-2 border border-transparent text-sm font-medium rounded-md text-white bg-tolidatColor hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"> View more</a>
                        </div>
                    </div>
                <?php else : ?>
            ...
            <?php if (isset($list['side']['honour_list'])) : ?>
                <?php if (count($list['side']['honour_list']) > 1) : ?>
                    <div id="honours" class="bg-gray-50 border-2 rounded">
                        <h2 class="p-3 border-b bg-gray-200">Honors</h2>
                        <div class="p-3             content ltr content-detailP content-single carousel-vertical">
                        ...
                        <div class="px-3 pb-2">
                            <a href="<?php echo RELA_DIR . "honour/all/" . $list['side']['list']['Company_id'] ?>" class="inline-block py-1 px-2 border border-transparent text-sm font-medium rounded-md text-white bg-tolidatColor hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"> View More</a>
                        </div>
                    </div>
                <?php else : ?>
                    <div class="border-2">
            ...
            <?php if (isset($list['side']['news_list'])) : ?>
                <?php if (count($list['side']['news_list']) > 1) : ?>
                    <div id="news" class="bg-gray-50 border-2 rounded          text-header searchBox1 bestProduct whiteBg boxBorder roundCorner fullWidth">
                        <h2 class="p-3 border-b bg-gray-200">News</h2>
                        ...
                        <div class="px-3 pb-2">
                            <a href="<?php echo RELA_DIR . "companyNews/all/" . $list['side']['list']['Company_id'] ?>" class="inline-block py-1 px-2 border border-transparent text-sm font-medium rounded-md text-white bg-tolidatColor hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"> View More</a>
                        </div>
                    </div>
                <?php else : ?>
                    <div id="news" class="bg-gray-50 border-2 rounded       text-header searchBox1 bestProduct whiteBg boxBorder roundCorner fullWidth">
                        <h2 class="p-3 border-b bg-gray-200">Newspaper</h2>
                        <div class="p-3            content ltr content-detailP content-single carousel-vertical">
                            <?php foreach ($list['side']['news_list'] as $key => $value) : ?>
                                <div class="flex gap-2 mb-4            innerContent pull-right">
                                    <img src="<?php echo (!empty($value['image']) && file_exists(COMPANY_ADDRESS_ROOT . $value['company_id'] . '/news/90.90.' . $value['image']) ? COMPANY_ADDRESS . $value['company_id'] . '/news/90.90.' . $value['image'] : DEFULT_LOGO_ADDRESS); ?>" title="<?php echo  $value['title'] ?>" alt="<?php echo  ' خبر ' . $value['title'] ?>" class="w-20 h-20">
        ...
        <div class="border-2 my-4 rounded bg-gray-50">
            <h2 class="border-b p-3 bg-gray-200 ">Comments</h2>
            <div class="content ltr">
                ...
                <div class="w-full p-4 show-comment">
                    ...
                    ?>
                    <a href="<?php echo RELA_DIR . "survey/all/" . $list['side']['list']['Company_id'] ?>" class="inline-block mt-2 py-1 px-2 border border-transparent text-sm font-medium rounded-md text-white bg-tolidatColor hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Send comment</a>
                </div>
            </div>
        ...
        <div class="container mx-auto my-3 py-3 px-4">
            <div class="  border-t pt-3  overlayCompany keywords-container">
                <div class="text-header searchBox1 bestProduct whiteBg boxBorder roundCorner fullWidth">
                    <header>Popular people searched </header>
