                ...
                <div class="content rtl whiteBg boxBorder">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 pull-right mb-double">
                            <h6 title="<?php echo  $list['employment']['skill'] ?>">
                                <?php echo  $list['employment']['skill'] ?>
                            </h6></div>
                        <div class="col-xs-12 col-sm-12 col-md-12 pull-right mb-double">
                            <div class="titr">
                                <b class="title"><span class="icon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                    <span>حداقل حقوق:</span></b> <span><?php echo  $list['employment']['minSallary'] ?></span>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 pull-right mb-double">
                            <div class="titr">
                                <b class="title"><span class="icon"><i class="fa fa-usd" aria-hidden="true"> </i></span>
                                    <span>حداکثر حقوق:</span></b> <span><?php echo  $list['employment']['maxSallary'] ?></span>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 pull-right mb-double">
                            <div class="titr">
                                <b class="title"><span class="icon"> <i class="fa fa-university" aria-hidden="true"></i></span></b>
                                <span> تحصیلات:</span> <span><?php echo  $list['employment']['name'] ?></span>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 pull-right mb-double">
                            <div class="titr">
                                <b class="title"><span class="icon"><i class="fa fa-mobile" aria-hidden="true"></i></span></b>
                                <span><?php echo  $list['employment']['contactPhone'] ?></span>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 pull-right mb-double">
                            <b class="title"> <span class="icon"> <i class="fa fa-cogs" aria-hidden="true"></i></span>
                            </b><span>مهارت ها:</span> <span class="skill"><?php echo  $list['employment']['skill'] ?></span>
                        </div>
                        <div class="col-xs-6 col-sm-12 col-md-3 pull-right mb-double">
                            ...
                            <span><?php echo  $list['employment']['history'] . " سال " ?></span>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 pull-right mb-double">
                            <b class="title">توضیحات:</b>
                            <span class="detail"><?php echo  $list['employment']['description'] ?></span>
                        </div>
                    </div>
                </div>
            </div>
