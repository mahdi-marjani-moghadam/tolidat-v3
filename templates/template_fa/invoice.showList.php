...
<div class="row companyTable companyTable2">
    <div class="container-package-factor center-block package-border-gold roundCorner mb-double">
        ...
        <?php endif; ?>
        <div class="col-xw-12 col-sm-12 col-md-12">
        ...
        <div class="row background-factor roundCorner">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 noPadding mt mb text-center">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 pull-right noPadding">
                    <div class="col-xs-12 col-sm-12 col-md-12 pull-right mb">
                        <i class="fa fa-calendar" aria-hidden="true"></i>
                        <span class="">اعتبار پکیج:</span>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 pull-right mb">
                        یک ساله
                    </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 mt-double4">
            <a class="btn btn-success factor-btn-payment" href="<?php echo RELA_DIR . "invoice/payment/" . $list['Invoice_id']; ?>">پرداخت</a>
            <a class="btn btn-default factor-btn-edit " href="<?php echo RELA_DIR . "package" ?>">تغییر پکیج</a>
        </div>
    </div>
</div>
