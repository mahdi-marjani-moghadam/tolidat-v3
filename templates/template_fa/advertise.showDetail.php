                ...
                <div class="content rtl whiteBg boxBorder">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 pull-right mb-double">
                            ...
                            <span class="detail"><?= $list['advertise']['description'] ?></span>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 pull-right mb-double">
                            <b class="title">تاریخ شروع:</b>
                            <span class="detail"><?= convertDate($list['advertise']['startDate']) ?></span>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 pull-right mb-double">
                            <b class="title">تاریخ انقضا:</b>
                            <span class="detail"><?= convertDate($list['advertise']['expireDate']) ?></span>
                        </div>
                    </div>
                </div>
            </div>
