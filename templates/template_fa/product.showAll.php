        ...
        <div class="border-2 my-4 rounded bg-gray-50">
            <div id="products" class="text-header searchBox1 bestProduct whiteBg boxBorder roundCorner fullWidth container-product-Grouping productGrid">
                <h2 class="p-3 border-b bg-gray-200">
                    محصولات/خدمات (<?php echo  count($list['products']); ?> عدد)
                            ...
                            <li class="group ">
                                <div class="product-group border p-3 rounded  bg-white ">
                                    ...
                                    <div class="product-content pull-right rtl">
                                        ...
                                        <div class="tag rtl text-right  text-xs px-2 -mx-3 bg-gray-200 p-2 mb-2 leading-7 truncate ">دسته بندی: <span class="bg-white border-tolidatColor border rounded-full px-2">
                                                <?php echo  $fields['category_name'] ?>
                                            </span></div>

                                        <a class="displayBlock bg-tolidatColor text-white px-3 rounded-full" href="<?php echo  RELA_DIR . 'product/show/' . $fields['Product_id'] . "/" . cleanUrl($fields['title']) ?>">مشاهده بیشتر
                                        </a>
