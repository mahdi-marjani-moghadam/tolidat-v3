                                            ...
                                            <li>
                                                <a data-toggle="tooltip" data-placement="top" title="<?= $value['name'] ?>" class="company-name">
                                                    ...
                                                    <label for="province-<?= $value['province_id'] ?>" class="company-name"><?= $value['name'] ?>
                                                        <input type="checkbox" name="province[]" id="province-<?= $value['province_id'] ?>" value="<?= $value['name'] ?>"> </label> </a>
                        ...
                        <div class="whiteBg boxBorder roundCorner clear fullWidth">
                            ...
                            <div class="row mb-double">
                                <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                    <div class="alert alert-warning"><strong>موردی پیدا نشد! </strong><?php echo $msg; ?> </div>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                                                ...
                                                <ul class="dropdown-menu searchType">
                                                    <?php foreach ($list['list']['searchItem']['category'] as $a => $b) { ?>
                                                        <li class="color-white">
                                                            <span class="product-filter-container" data-toggle="tooltip" data-placement="top" data-original-title="<?= $list['list']['searchItem']['category'][$a]['title'] ?>">
                                                                <?= $list['list']['searchItem']['category'][$a]['title'] ?>
                                                            </span>
                                                            <span class="close-filter-container">
                                                                <a href="#" name="a_category" title="<?= $list['list']['searchItem']['category'][$a]['title'] ?>">
                                                                    <i class="fa" name="category[]" id="<?= $list['list']['searchItem']['category'][$a]['Category_id'] ?>" title="<?= $list['list']['searchItem']['category'][$a]['title'] ?>"> </i>
                                                                </a>
                                                            </span>
                                                        </li>
                                                    <?php } ?>
                        ...
                        <?php foreach ($list['list']['company'] as $key => $value) { ?>
                            <div class="searchBox whiteBg boxBorder roundCorner fullWidth mb-double contentPro contentPro-profile">
                                                ...
                                                <div class="col-xs-12 col-sm-5 col-md-3 pull-right boxA noPadding">
                                                    <div class="side-bar-knob Percent-box center-block">
                                                        ...
                                                        <ul class="icon-side text-center">
                                                            ...
                                                            ?>
                                                                <li class="<?= ((int)$value['rate']['product_count'] == 0 ? "disabled" : ""); ?>">
                                ...
                                <div class="panel-footer tag">
                                    ...
                                    <a class="pull-right" href="<?= RELA_DIR . "search/type/تولیدی/province/" . $list['list']['searchProvince'][$value['state_id']]['name'] ?>" class="city"><?= $list['list']['searchProvince'][$value['state_id']]['name'] ?></a>
                                    ...
                                    <?php foreach ($value['category_title'] as $cat_id => $category) : ?>
                                        <a class="pull-right" href="<?= RELA_DIR . "company/type/تولیدی/category/" . $cat_id ?>"> <?php echo $category;
                                                                                                                                    echo ($count > 1 ? " , " : "");
                                                                                                                                    $count-- ?></a>
                                    <?php endforeach; ?>
                                </div>
                                ...
                                <div class="boxGrid-pane whiteBg boxBorder roundCorner">
                                    <div class="row margin-bottom">
                                        ...
                                        <div class="col-xs-12 col-sm-7 col-md-7 list2 boxLeft">
                                            <a href="<?php echo RELA_DIR . 'product/Detail/' . $value['Company_products_id'] . '/' . $value['title']; ?>">
                                                <p>
                                                    <span> <i class="fa fa-sticky-note" aria-hidden="true"></i> <b>نام تولیدی:</b> </span><span><?php echo ($value['title'] != "" ? $value['title'] : "-"); ?></span>
                                                </p>
                                                <p>
                                                    <span>
                                                        <i class="fa fa-file-text" aria-hidden="true"></i> <b>توضیحات:</b>
                                                    </span><span><?php echo ($value['description'] != "" ? $value['description'] : "-"); ?></span>
                                                </p>
                                            </a>
                                        </div>
                                    ...
                                    <div class="row noMargin">
                                        <?php foreach ($list['searchSuggestion']['value'] as $key => $value) { ?>
                                            <div class="col-xs-12 col-sm-4 col-md-3 pull-right">
                                                <a class="text-right transition" href="<?= RELA_DIR ?>search/type/<?= (($list['searchSuggestion']['type'] == '0') ? 'تولیدی' : 'محصولات'); ?>/q/<?= $value; ?>" name="<?= $value; ?>" title="<?= $value; ?>">
                                                    <?= $value ?>
                                                </a>
                                            </div>
                                        <?php } ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 pagination-search pagination-search1 pull-right">
                            <div class="whiteBg boxBorder roundCorner fullWidth mb Pagination">
                                ...
                                <div class="input-group center-block">
                                    <input type="text" class="form-control input-search" id="input-search" placeholder="شماره صفحه ..."> <span class="input-group-btn btn-arrow">
