        ...
        <div class="container-editPassword">
            ...
            <form id="editprofile" class="edit-profile" action="/profile/editPassword" method="POST" data-toggle="validator">
                ...
                <div class="form-group mb">
                    ...
                    <input required class="form-control" data-error="لطفا نام را وارد نمایید" type="text" name="name" id="name" value="<?php echo  $list['name'] ?>">
                </div>
                ...
                <div class="form-group mb">
                    ...
                    <input required class="form-control" data-error="لطفا نام خانوادگی را وارد نمایید" type="text" name="family" id="family" value="<?php echo  $list['family'] ?>">
                </div>
                ...
                <div class="form-group mb">
                    ...
                    <input required class="form-control set-font-latin" data-error="لطفا شماره تماس را وارد نمایید" type="text" name="mobile" id="mobile" value="<?php echo  $list['mobile'] ?>">
                </div>
                ...
                <div class="form-group mb">
                    ...
                    <input required class="form-control set-font-latin ltr" data-error="لطفا ایمیل را وارد نمایید" type="email" name="email" id="email" value="<?php echo  $list['email'] ?>">
                </div>
