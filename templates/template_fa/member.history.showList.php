...
<!--Modal add-->
<div class="holder-modal modal-history modal fade container-floatinglabel" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title roundCorner" id="myModalLabel">افزودن سوابق</h5>
                <p id="message"></p>
            </div>
            <div class="modal-body">
                ...
                <form id="addHistory" class="form" enctype="multipart/form-data" method="post" data-toggle="validator">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 pull-left">
                            <?php /*<a class="logoNew roundCorner">
...
<!--Modal Edit-->
<div class="holder-modal modal-history modal fade container-floatinglabel" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog  modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h5 class="modal-title roundCorner" id="myModalLabel">ویرایش سوابق</h5>
                <p id="message"></p>
            </div>
            <div class="modal-body">
                <div class="iziAdd-container"></div>
                ...
                <form id="editHistory" class="form" enctype="multipart/form-data" data-toggle="validator" method="post">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6 pull-right">
                            <div class="form-group mb">
...
<script>
    ...
    $(document).ready(function() {
            ...
            $.httpRequest('/member/history/edit/', 'post', formData)
                .then(function(data) {
                    ...
                    if (response.fields.result == -1) {
                        ...
                        var history_d_id = response.fields.History_d_id;
                        var history_d_id_old = response.fields.History_d_id_old;
                        var history_d_id_oldest = response.fields.History_d_id_oldest;
                        ...
                        $(".remove-history").each(function() {
                            if ($(this).data('value') == history_d_id_old || $(this).data('value') == history_d_id_oldest) {
                                ...
                                $(this).find('.link-edit').data('value', history_d_id);
        ...
        $body.on('click', '.link-trash', function(e) {
            e.preventDefault();
            var dataID = $(this).data('value'),
                lastItem = $body.find('.remove-history').length;
