...
<div class="row add-honour">
    <?php if (isset($list['list']) && count($list['list'])): ?>
        <?php foreach ($list['list'] as $id => $fields): ?>
            <div class="col-xs-12 col-sm-6 col-md-4 pull-right mb5 remove-honour" data-value="<?= $fields['Honour_d_id'] ?>">
                    ...
                    <h3>
                        <div class="kebabMenu">
                            ...
                            <ul class="kebab-menu-content roundCorner boxBorder">
                                <li><a class="link-edit" data-value="<?= $fields['Honour_d_id'] ?>"><i class="fa fa-pencil" aria-hidden="true"></i><span>ویرایش </span></a></li>
                                <li><a class="link-trash" data-value="<?= $fields['Honour_d_id'] ?>"><i class="fa fa-trash-o" aria-hidden="true"></i><span>حذف</span></a></li>
                            </ul>
                        </div>
                        <div class="logo">
...
<script>
    $(function () {
        ...
        function editItem(dataID, $this) {
            ...
            $.post('/member/honour/editAjax/', {id: dataID}, function (data) {
