...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="holder-title center-block">
            <span data-intro=" در این قسمت هرگونه آگهی اعم از آگهی تولید و ... را درج نمایید." class="title-pro">ثبت آگهی</span> <span class="betaVersion">(نسخه آزمایشی)</span>
            <button data-intro="اضافه کردن آگهی" type="button" class="i-add btn btn-sm pull-left add-btnPro" data-toggle="modal" data-target="#myModal2" data-backdrop="static">
...
<div class="row add-advertise">
    <?php if (isset($list['list']) && count($list['list'])) : ?>
        <?php foreach ($list['list'] as $id => $fields) : ?>
            <div class="col-xs-12 col-sm-6 col-md-4 pull-right mb5 remove-honour" data-value="<?php echo  $fields['Advertise_id'] ?>">
                    ...
                    <h3>
                        <div class="kebabMenu">
                            ...
                            <ul class="kebab-menu-content roundCorner boxBorder">
                                <li>
                                    <a class="link-edit" data-value="<?php echo  $fields['Advertise_id'] ?>"><i class="fa fa-pencil" aria-hidden="true"></i><span>ویرایش </span></a>
                                </li>
                                <li>
                                    <a class="link-trash" data-value="<?php echo  $fields['Advertise_id'] ?>"><i class="fa fa-trash-o" aria-hidden="true"></i><span>حذف</span></a>
                                </li>
                            </ul>
                        </div>
                        <div class="logo">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 pull-left">
                            <div class="form-group mb full-date-picker">
                                <label for="startDate">تاریخ شروع</label> <input name="startDate" type="text" class="form-control datePicker" id="startDate" required data-error="لطفا تاریخ شروع خود را وارد نمایید">
                            </div>
                            ...
                            <div class="form-group mb full-date-picker">
                                <label for="expireDate">تاریخ انقضا </label> <input name="expireDate" type="text" class="form-control datePicker" id="expireDate" required data-error="لطفا تاریخ انقضا خود را وارد نمایید">
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 center-block">
                            <div class="docs-buttons">
                                <div class="img-container upload-msg">
                                    <img class="width image-crop img-cropper" src="<?php echo  DEFULT_LOGO_ADDRESS ?>" alt="Picture">
                                </div>
                ...
                <form id="editAdvertise" class="form" enctype="multipart/form-data" method="post" data-toggle="validator" novalidate="novalidate">
                    <div class="row noMargin">
                        <div class="col-xs-12 col-sm-6 col-md-6 pull-right">
                            ...
                            <div class="form-group mb">
                                <label for="description">توضیحات</label>
                                <textarea data-minWord="6" name="description" class="form-control rtl progressText" rows="3" id="description"></textarea>
                            </div>
...
<script>
    ...
    $(function() {
        ...
        function editItem(dataID) {
            ...
            $.post('/member/companyAdvertise/editAjax/', {
                id: dataID
            }, function(data) {
