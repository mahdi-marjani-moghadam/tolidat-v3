...
class looeic extends DB
{
    ...
    function validator($rules = null, $fields = null)
    {
    ...
    function links($config)
    {
        ...
        // SELECT * FROM letter_actions WHERE   status = 1
    ...
    private function insert($fields = '')
    {
        ...
        $sql = " INSERT INTO " . $this->TABLE_NAME . "( " . $sql_key . " ) VALUES ( " . $sql_val . " ) ";
        try {
            $stmt = $conn->prepare($sql);
            $stmt->execute();
        } catch (PDOException $e) {
            ...
            echo $sql . '<br>';
            echo "Error: Table(" . $this->TABLE_NAME . ') ' . $e->getMessage();
            dd('');
        }
    ...
    public static function update($fields, $where)
    {
        ...
        try {
            ...
            echo $sql . '<br>';
            echo "Error: Table(" . $obj->TABLE_NAME . ') ' . $e->getMessage();
            dd('');
        }
