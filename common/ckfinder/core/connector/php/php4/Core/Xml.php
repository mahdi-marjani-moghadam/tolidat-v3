...
class CKFinder_Connector_Core_Xml
{
    ...
    /**
     * SendStrategy XML headers to the browser (and force browser not to use cache)
     * @access private
     */
    ...
    /**
     * SendStrategy error message to the browser. If error number is set to 1, $text (custom error message) will be displayed
